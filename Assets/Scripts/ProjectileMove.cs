...
public class ProjectileMove : MonoBehaviour
{
    ...
    public Texture projectileLogo = null;
    ...
    void Start()
    {
        //projectileLogo = GetComponent<SpriteRenderer>().sprite.texture;
    }
    ...
    void Update()
    {
        ...
        if (GetComponent<Rigidbody2D>().IsSleeping() != true)
        {
            //Destroy apples after x seconds
